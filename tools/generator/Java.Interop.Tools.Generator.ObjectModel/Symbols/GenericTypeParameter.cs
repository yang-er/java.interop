...
namespace MonoDroid.Generation {
	...
	public class GenericTypeParameter : ISymbol {
		...
		{
			return String.Format ("({0}{4}) global::Java.Lang.Object.GetObject<{3}> (ref {1}, {2})", type, varname, owned ? "JniObjectReferenceOptions.CopyAndDispose" : "JniObjectReference.None", opt.GetOutputName (FullName), opt.NullableOperator);
		}
